...
class TasksState extends Equatable {
  ...
  const TasksState({
    ...
    this.imageUrls = const [], // Initialize imageUrls as an empty list
  });
  ...
  List<Object?> get props => [
    ...
    favoriteTasks,
    removedTasks,
    imageUrls, // Include imageUrls in props
  ];
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'imageUrls': imageUrls.toList(), // Serialize imageUrls
    };
  }
  ...
  factory TasksState.fromMap(Map<String, dynamic> map) {
    return TasksState(
      ...
      imageUrls: List<String>.from(map['imageUrls'] ?? []), // Deserialize imageUrls
    );
  }
}
